...
namespace Nyerguds.GameData.Dynamix
{
    public static class DynamixCompression
    {
        ...
        public static Byte[] LzwDecode(Byte[] buffer, Int32? startOffset, Int32? endOffset, UInt32 decompressedSize)
        {
        ...
        public static Byte[] RleDecode(Byte[] buffer, UInt32? startOffset, UInt32? endOffset, UInt32 decompressedSize, Boolean abortOnError)
        {
            Byte[] outputBuffer = new Byte[decompressedSize];
