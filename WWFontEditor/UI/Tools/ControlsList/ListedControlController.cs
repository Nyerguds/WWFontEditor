namespace Nyerguds.Util.Ui
{
    ...
    /// </summary>
    /// <typeparam name="U">The type of the info object. Can be chosen freely.</typeparam>
    public interface ListedControlController<in U>
    {
        /// <summary>
        ...
        void UpdateControlInfo(U updateInfo);
    }
}
